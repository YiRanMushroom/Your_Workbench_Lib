...
namespace ywl {
    inline namespace basic {
        ...
        public:
            ...
            constexpr result_of_t(value_type &&value) : value(std::move(value)) {}
        ...
        public:
            ...
            constexpr error_of_t(value_type &&value) : value(std::move(value)) {}
        ...
        public:
            ...
            constexpr result_state get_state() const {
                if (!m_data.has_value()) {
        ...
        constexpr auto &&std::get(result<Result_Type, Error_Type> &&self) {
            result_state state = self.get_state();
            if constexpr (I == 0) {
                if (state == some) {
